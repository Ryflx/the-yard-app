...
export default function RootLayout({
  ...
  return (
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          formFieldInput: "bg-[#0e0e0e] border-[#494847] !text-white !caret-white placeholder:text-[#777575] [&:focus]:!text-white [&:active]:!text-white",
          formFieldInputShowPasswordButton: "!text-[#adaaaa] hover:!text-white",
    ...
    >
      ...
      >
        <head>
          {/* eslint-disable-next-line @next/next/no-page-custom-font -- Material Symbols is a variable icon font; not bundleable via next/font */}
          <link
