...
const SEED_MOVEMENTS: { name: string; category: MovementCategory }[] = [
  ...
  { name: "Clean pull + hang squat clean", category: "OLYMPIC" },
  ...
  { name: "Double DB bench press", category: "STRENGTH" },
  { name: "Double DB floor press", category: "STRENGTH" },
  { name: "Double DB push press", category: "STRENGTH" },
  ...
  { name: "Hip clean", category: "ACCESSORY" },
