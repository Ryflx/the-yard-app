...
const CROSSFIT_MOVEMENTS: { name: string; category: MovementCategory }[] = [
  ...
  { name: "Legless rope climbs", category: "GYMNASTICS" },
  { name: "Strict legless rope climbs", category: "GYMNASTICS" },
  { name: "Kipping legless rope climbs", category: "GYMNASTICS" },
  { name: "Seated start rope climbs", category: "GYMNASTICS" },
